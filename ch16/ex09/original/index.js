...
import http from "http"; // Use "https" if you have a certificate
import url from "url"; // For parsing URLs
import path from "path"; // For manipulating filesystem paths
    ...
    server.on("request", (request, response) => {
        ...
        // Otherwise, serve a file from the local directory.
            ...
            stream.once("readable", () => {
                ...
                // file reader stream to the response. Thepipe will
...
serve(process.argv[2] || "ch16/ex09/original/", parseInt(process.argv[3]) || 8000);