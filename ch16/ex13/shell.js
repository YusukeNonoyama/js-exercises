    ...
    case ">": // RedirCmd
      {
        ...
        const outputStream = fs.createWriteStream(cmd.file);
        await runcmd(cmd.cmd, stdin, outputStream);
      }
      break;
    ...
    case "<": // RedirCmd
      {
        ...
        const inpuptStream = fs.createReadStream(cmd.file);
        await runcmd(cmd.cmd, inpuptStream, stdout);
      }
      break;
