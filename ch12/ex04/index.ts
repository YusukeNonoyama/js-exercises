...
function* filter(iterable: Iterable<number>, predicate: (x: number) => boolean): Generator<number, void, unknown> {
...
export function* primes(): Generator<number, void, unknown> {
  function* sieve(intIterable: IterableIterator<number>): Generator<number, void, unknown> {
