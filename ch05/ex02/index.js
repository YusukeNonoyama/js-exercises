export class AddBackslash {
    ...
    static withSwitch(inputText) {
        ...
        for (let letter of inputText){
            switch(letter) {
                case "0": letter = "\\" + letter; break;
                case "b": letter = "\\" + letter; break;
                case "t": letter = "\\" + letter; break;
                case "n": letter = "\\" + letter; break;
                case "v": letter = "\\" + letter; break;
                case "f": letter = "\\" + letter; break;
                case "r": letter = "\\" + letter; break;
