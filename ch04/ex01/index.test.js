...
describe("complex number calculation", () => {
    describe("case1", () => {
        ...
        it("add", () => {
            expect(JSON.stringify(add(z1, z2))).toBe(JSON.stringify({ real: "6.00", im: "4.00" }));
        });
        it("sub", () => {
            expect(JSON.stringify(sub(z1, z2))).toBe(JSON.stringify({ real: "-4.00", im: "0.00" }));
        });
        it("mul", () => {
            expect(JSON.stringify(mul(z1, z2))).toBe(JSON.stringify({ real: "1.00", im: "12.00" }));
        });
        it("div", () => {
            expect(JSON.stringify(div(z1, z2))).toBe(JSON.stringify({ real: "0.31", im: "0.28" }));
        });
    });
    describe("case2", () => {
        ...
        it("add", () => {
            expect(JSON.stringify(add(z1, z2))).toBe(JSON.stringify({ real: "-3.70", im: "-1.60" }));
        });
        it("sub", () => {
            expect(JSON.stringify(sub(z1, z2))).toBe(JSON.stringify({ real: "6.30", im: "-2.40" }));
        });
        it("mul", () => {
            expect(JSON.stringify(mul(z1, z2))).toBe(JSON.stringify({ real: "-5.70", im: "10.52" }));
        });
        it("div", () => {
            expect(JSON.stringify(div(z1, z2))).toBe(JSON.stringify({ real: "-0.29", im: "0.38" }));
        });
    });
